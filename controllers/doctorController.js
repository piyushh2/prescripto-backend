...
const appointmentCancel = async (req, res) => {
  try {
    ...
    else return res.json({ success: true, message: "Cancellation Failed" })
  } catch (error) {
    console.log(error)
    res.json({ success: false, message: error.message })
  }
...
export { doctorList, loginDoctor, doctorAppointments, appointmentComplete, appointmentCancel, doctorDashboard, doctorProfile, updateDoctorProfile }